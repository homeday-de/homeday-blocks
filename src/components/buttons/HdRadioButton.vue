<template>
  <div @click="select" @keyup.enter.space="select" class="radioButton" role="button" tabindex="0">
    <input
      v-if="name && value"
      type="radio"
      :name="name"
    ...
    <div class="radioButton__iconWrapper radioButton__iconWrapper--desktop">
      <div :style="setBackgroundImage(desktopIcon)" class="radioButton__icon" />
      <div
    ...
    <div class="radioButton__iconWrapper radioButton__iconWrapper--mobile">
      <div :style="setBackgroundImage(mobileIcon)" class="radioButton__icon" />
    </div>
    <label :for="name" class="radioButton__label" v-html="label" />
    <HdIcon :src="chevronIcon" class="radioButton__chevron" />
  </div>
</template>
